      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
            You own your health records. Control who sees them, when, and for
            how long.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
          <div className="bg-white rounded-lg p-6 sm:p-8 shadow-lg">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-6">
              With Mediloop, you decide who can access your health information.
          ...
          <div className="bg-white rounded-lg p-6 sm:p-8 shadow-lg">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-6">
              Your health data is protected with the same security used by
              banks, in full compliance with Uganda's Data Protection Act 2019.
            </p>
            <ul className="text-sm sm:text-base text-gray-600 space-y-2">
        ...
        <div className="bg-teal-50 rounded-2xl p-8 sm:p-12 mb-12 sm:mb-16">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold mx-auto mb-4 text-lg sm:text-xl">
                1
              </div>
              ...
              <p className="text-gray-700 text-xs sm:text-sm">
                View all your medical records from your phone
              </p>
            </div>
            <div className="text-center">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold mx-auto mb-4 text-lg sm:text-xl">
              ...
              <p className="text-gray-700 text-xs sm:text-sm">
                Choose which doctors can see your records
              </p>
            </div>
            <div className="text-center">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold mx-auto mb-4 text-lg sm:text-xl">
              ...
              <p className="text-gray-700 text-xs sm:text-sm">
                Access expires automatically when you choose
              </p>
            </div>
            <div className="text-center">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold mx-auto mb-4 text-lg sm:text-xl">
              ...
              <p className="text-gray-700 text-xs sm:text-sm">
                See complete audit log of all access
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-teal-600 to-green-600 rounded-2xl p-8 sm:p-12 text-white text-center">
          ...
          <p className="text-lg sm:text-xl mb-6 sm:mb-8">
            Create your Universal Health ID and start managing your records
            today.
          </p>
          <Link
