...
export const metadata: Metadata = {
  ...
  description:
    "Register for your Universal Health ID (UHID) and access healthcare across Uganda. One secure health identity linked to your national ID.",
  alternates: { canonical: "https://mediloop.co/uhid" },
  openGraph: {
    title: "Universal Health ID (UHID) — Mediloop",
    description:
      "Register for your Universal Health ID (UHID) and access healthcare across Uganda.",
...
export default function UHIDPage() {
  const structuredData = {
    ...
    description:
      "Universal Health ID: a secure digital health identity linked to national ID for Ugandans. Access medical records, consultations, and provider services across the Mediloop network.",
    provider: {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
            Your lifetime health identity. One ID for all your medical records,
            accessible anywhere in Uganda.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
          <div className="bg-white rounded-lg p-6 sm:p-8 shadow-lg">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-6">
              Your Universal Health ID is linked to your National ID and gives
              you instant access to healthcare services across Uganda.
            </p>
          ...
          <div className="bg-white rounded-lg p-6 sm:p-8 shadow-lg">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-6">
              Take control of your health records and get better care wherever
              you go.
            </p>
            <ul className="text-sm sm:text-base text-gray-600 space-y-2">
        ...
        <div className="bg-teal-50 rounded-2xl p-8 sm:p-12 mb-12 sm:mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-lg sm:text-xl mx-auto mb-4">
                1
              </div>
              ...
              <p className="text-sm sm:text-base text-gray-700">
                Visit app.mediloop.co and register with your National ID
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-lg sm:text-xl mx-auto mb-4">
              ...
              <p className="text-sm sm:text-base text-gray-700">
                Your Universal Health ID is created instantly
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-lg sm:text-xl mx-auto mb-4">
              ...
              <p className="text-sm sm:text-base text-gray-700">
                Book appointments, consult doctors, manage your health
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-teal-600 to-green-600 rounded-2xl p-8 sm:p-12 text-white text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            Get Your Universal Health ID Today
          </h2>
          <p className="text-lg sm:text-xl mb-6 sm:mb-8">
            Join thousands of Ugandans taking control of their health records.
          </p>
          <Link
