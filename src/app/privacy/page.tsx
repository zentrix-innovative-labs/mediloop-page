          ...
          <div className="prose prose-sm sm:prose-base max-w-none">
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 mb-4">
                Mediloop Health ("Mediloop," "we," "us," or "our") is committed
                to protecting your privacy and ensuring the security of your
                personal health information. This Privacy Policy explains how we
                collect, use, disclose, and safeguard your information when you
                use our services, including our website, mobile applications,
                WhatsApp integration, and Universal Health ID (UHID) platform.
              </p>
              <p className="text-sm sm:text-base text-gray-700">
                By using Mediloop services, you agree to the collection and use
                of information in accordance with this policy. We comply with
                Uganda's Data Protection and Privacy Act, 2019, and
            ...
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 mb-4">
                We share your health information with authorized healthcare
                providers (doctors, nurses, pharmacists, lab technicians) only
                when necessary to provide you with care and only with your
                explicit consent.
              </p>
              ...
              <p className="text-sm sm:text-base text-gray-700 mt-4">
                ...
                agreements and are not permitted to use your data for any other
                purpose.
              </p>
              ...
              <p className="text-sm sm:text-base text-gray-700">
                ...
                in response to court orders, government requests, or to comply
                with legal obligations. We will notify you of such requests
              ...
              <p className="text-sm sm:text-base text-gray-700">
                In cases of public health emergencies or disease outbreaks, we
                may share anonymized, aggregated data with government health
                authorities to support disease surveillance and public health
                responses.
              </p>
            </section>
            ...
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 mb-4">
                You have the right to access and review all your health
                information stored in Mediloop at any time through your patient
              ...
              <p className="text-sm sm:text-base text-gray-700">
                ...
                incomplete, you have the right to request corrections through
                your healthcare provider or by contacting us.
              </p>
              ...
              <p className="text-sm sm:text-base text-gray-700">
                You can request a complete export of your health records in a
                portable, machine-readable format at any time.
              </p>
              ...
              <p className="text-sm sm:text-base text-gray-700">
                You may request deletion of your account, though we may be
                required to retain certain medical records for legal and
                regulatory compliance purposes (typically 7 years from last
                interaction).
              </p>
            </section>
            ...
            <section className="mb-8 sm:mb-12">
              ...
              <ul className="list-disc pl-6 sm:pl-8 space-y-2 text-sm sm:text-base text-gray-700">
                <li>
                  Active health records: Retained indefinitely while you use our
                  services
                </li>
                <li>
                  After account closure: Minimum 7 years as required by Ugandan
                  healthcare regulations
                </li>
                <li>
                  Anonymized research data: May be retained indefinitely for
            ...
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700">
                Mediloop services can be used for children under 18. Health
                records for minors are managed by parents or legal guardians
                until the child reaches 18 years of age. Parents/guardians have
                full access to and control over their children's health
                information.
              </p>
            </section>
            ...
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700">
                Your data is primarily stored within Uganda and Africa. If we
                need to transfer data outside Uganda for specific services (such
                as specialized cloud infrastructure), we ensure appropriate
            ...
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700">
                ...
                our website and sending notifications through WhatsApp or email.
            ...
            <section className="mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 mb-4">
                ...
                Privacy Policy or your health data, please contact us:
              </p>
