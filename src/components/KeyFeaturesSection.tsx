  ...
  const features = [
    {
      ...
      description:
        "Get instant answers to your health questions through WhatsApp. No app download, no waiting rooms. Just message us your symptoms and get reliable medical guidance immediately.",
    ...
    },
    {
      ...
      description:
        "Never lose your medical records again. Your Universal Health ID keeps everything in one place - test results, prescriptions, doctor visits - accessible from any hospital or clinic.",
      color: "text-blue-600",
      bgColor: "bg-blue-50",
    },
    {
      ...
      description:
        "Book appointments with verified doctors, get prescriptions delivered to your door, and order lab tests - all from your phone. Healthcare made simple.",
    ...
    },
    {
      ...
      description:
        "You decide who sees your medical information. Bank-level security keeps your health data safe. No one can access it without your permission.",
      color: "text-teal-600",
      bgColor: "bg-teal-50",
    },
    {
      ...
      description:
        "No more repeat tests when you change hospitals. No more lost prescriptions. Your complete medical history travels with you, saving you time and money.",
    ...
    },
    {
      ...
      description:
        "From Kampala to the villages. Whether you're at Mulago Hospital or a rural health center, your health records are always available.",
      color: "text-red-600",
      bgColor: "bg-red-50",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Simple, fast, and secure. Get the care you need, when you need it,
            from anywhere in Uganda.
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Send us a message on WhatsApp with your health question. Get
                instant, reliable medical advice - completely free.
              </p>
